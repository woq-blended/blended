...
private[modules] class ServicesWatcher[I <: AnyRef](
  interface: Class[I],
...
//    }
//
//    val tracker = new ServiceTracker[I](context, context createFilter fullFilter.toString, null) {
//
//      override def addingService(reference: ServiceReference[I]) = {
//        val service = context getService reference
//        val serviceEvent = AddingService(service.asInstanceOf[I], reference.properties)
...
//      }
//
//      override def modifiedService(reference: ServiceReference[I], service: I) {
//        val serviceEvent = ServiceModified(service.asInstanceOf[I], reference.properties)
//        if (handler.isDefinedAt(serviceEvent)) {
//          handler(serviceEvent)
...
//      }
//
//      override def removedService(reference: ServiceReference[Nothing], service: Nothing) {
//        val serviceEvent = ServiceRemoved(service.asInstanceOf[I], reference.properties)
//        if (handler.isDefinedAt(serviceEvent)) {
//          handler(serviceEvent)
