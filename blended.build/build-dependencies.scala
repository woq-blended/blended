...
val blendedDockerDemoApacheDS = BlendedModule("blended.docker.demo.apacheds")
...
val blendedMgmtApp = BlendedModule("blended.mgmt.app")
...
val blendedPrickleAkkaHttp = BlendedModule("blended.prickle.akka.http")
...
val blendedTestSupportPojosr = BlendedModule("blended.testsupport.pojosr")
