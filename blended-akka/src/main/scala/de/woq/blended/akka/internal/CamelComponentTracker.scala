...
import de.woq.blended.akka.protocol.{TrackerModifiedService, TrackerRemovedService, TrackerAddingService}
...
class CamelComponentTracker extends OSGIActor with ActorLogging with BundleName {
  ...
  override def bundleSymbolicName = "de.woq.blended.akka"
