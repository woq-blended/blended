...
BlendedModel(
  ...
  properties = Map(
    ...
    "shiro.version" -> BlendedVersions.apacheShiroVersion,
    ...
    "commons.exec.version" -> commonsExec.version.get,
    ...
    "docker-java.version" -> BlendedVersions.dockerJavaVersion,
    "pax-swissbox.version" -> "1.7.0",
    "loglevel.test" -> "INFO",
    "jasypt.version" -> "1.9.0_1",
    "stax.api.version" -> "2.2.0",
    "xbean.version" -> "3.16",
    "camel.version" -> BlendedVersions.camelVersion,
    ...
    "shapeless.version" -> shapeless.version.get,
    ...
    "parboiled.version" -> BlendedVersions.parboiledVersion,
    "pax-web.version" -> "3.1.0",
    "war.plugin.version" -> "2.6",
    "bundle.plugin.version" -> "3.0.1",
    "xbean.asm4.version" -> "3.16",
    "commons.collections.version" -> "3.2.1",
    "jolokia.version" -> BlendedVersions.jolokiaVersion,
    "activemq.version" -> BlendedVersions.activeMqVersion,
