...
package blended.persistence.neo4j.internal.person

import java.util.UUID

import blended.persistence.protocol.protocol.PersistenceProperties
import blended.persistence.protocol.{DataObject, DataObjectFactory}
