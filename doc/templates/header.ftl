...
<head>
  ...
  <script src="${config.site_host}/js/bootstrap.min.js"></script>
  <script src="${config.site_host}/js/perfect-scrollbar.js"></script>
  <script src="${config.site_host}/js/highlight/highlight.min.js"></script>
